...
% ---------------------------------------------------------------
% Include the CVPR-derived package in rebuttal mode
...
% rebuttal.aux before re-running latex.  (Or just hit 'q' on the first latex
...
After receiving paper reviews, the authors may optionally submit a rebuttal to address the reviewers' comments. The entire rebuttal must fit on \textbf{one page}, including any references. Please follow the steps and style guidelines outlined below for submitting your author response.
...
{\bf Make sure to update the paper ID in the appropriate place in the \verb+tex+ file.}
