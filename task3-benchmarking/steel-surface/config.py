...
# Paths
DATASET_DIR = os.environ.get("DATASET_DIR", "../../datasets/neu-cls")
TEST_MANIFEST = os.path.join(DATASET_DIR, "test_manifest.json")
...
5. ROLLED_IN_SCALE: oxide scale pressed into surface during rolling, elongated marks parallel to rolling direction
6. SCRATCHES: linear marks or grooves on the surface, directional damage

Respond with ONLY a JSON object:
{"defect_class": "<crazing|inclusion|patches|pitted_surface|rolled_in_scale|scratches>"}"""
...
- crazing, inclusion, patches, pitted_surface, rolled_in_scale, or scratches

Respond with ONLY JSON: {"defect_class": "<crazing|inclusion|patches|pitted_surface|rolled_in_scale|scratches>"}"""
